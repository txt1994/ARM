/**
  ******************************************************************************
  * 文件:    stm32f4xx_cryp_des.c
  * 作者:    MCD Application Team
  * 版本:    V1.8.0
  * 日期:    04-November-2016
  * 简介:    该文件提供高级函数以在 ECB/CBC 模式下使用 DES 加密和解密输入消息。
...
@verbatim
 ...
 [..]
   ...
   (#) 使用 CRYP_DES_ECB() 函数在 ECB 模式下使用 DES 进行加密和解密。

   (#) 使用 CRYP_DES_CBC() 函数在 CBC 模式下使用 DES 进行加密和解密。
