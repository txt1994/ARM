/**
  ******************************************************************************
  * 文件:    stm32f4xx_dbgmcu.h
  * 作者:    MCD Application Team
  * 版本:    V1.8.0
  * 日期:    04-November-2016
  * 简介:    此文件包含 DBGMCU 固件库的所有功能原型.
  ******************************************************************************
  * @attention
  *
...
/* Exported macro ------------------------------------------------------------*/
/* Exported functions --------------------------------------------------------*/
uint32_t DBGMCU_GetREVID(void); // 返回设备修订标识符。
uint32_t DBGMCU_GetDEVID(void); // 返回设备标识符。
void DBGMCU_Config(uint32_t DBGMCU_Periph, FunctionalState NewState); // 配置 MCU 处于调试模式时的低功耗模式行为。
void DBGMCU_APB1PeriphConfig(uint32_t DBGMCU_Periph, FunctionalState NewState); // 当 MCU 处于调试模式时配置 APB1 外设行为。
void DBGMCU_APB2PeriphConfig(uint32_t DBGMCU_Periph, FunctionalState NewState); // 当 MCU 处于调试模式时配置 APB2 外设行为。
