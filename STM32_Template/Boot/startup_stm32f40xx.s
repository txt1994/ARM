...
;* Description        : 用于 MDK-ARM 工具链的 STM32F40xxx/41xxx 器件向量表。
;*                      与 startup_stm32f40_41xxx.s 相同并为遗留目的而维护此模块执行：
;*                      - 设置初始 SP
...
; <h> 堆配置
;   <o>  堆大小 (in Bytes) <0x0-0xFFFFFFFF:8>
; </h>
...
__Vectors       DCD     __initial_sp               ; 栈顶
                ...
                DCD     PVD_IRQHandler                    ; 通过 EXTI 线检测进行 PVD                        
                DCD     TAMP_STAMP_IRQHandler             ; 通过 EXTI 线篡改和时间戳           
                DCD     RTC_WKUP_IRQHandler               ; 通过 EXTI 线唤醒 RTC                      
                ...
                DCD     TIM1_BRK_TIM9_IRQHandler          ; TIM1 中断和 TIM9                   
                DCD     TIM1_UP_TIM10_IRQHandler          ; TIM1 更新和 TIM10                
                DCD     TIM1_TRG_COM_TIM11_IRQHandler     ; TIM1 触发和换向和 TIM11
